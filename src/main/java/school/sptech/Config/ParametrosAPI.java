...
public class ParametrosAPI {
    private static String TOKEN = "OMdLdpCD-RiCiiEu6UqVsI8wPc75d6kS1wJZ5lpL";
    ...
    public static void setTOKEN(String TOKEN) {
        school.sptech.Config.ParametrosAPI.TOKEN = TOKEN;
    }
    ...
    public static void setTIMEOUT(String TIMEOUT) {
        school.sptech.Config.ParametrosAPI.TIMEOUT = TIMEOUT;
    }
